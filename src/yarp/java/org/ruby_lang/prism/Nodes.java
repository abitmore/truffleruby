...
public abstract class Nodes {
    ...
    public static final String[] EMPTY_IDENTIFIER_ARRAY = {};
    ...
    public static final class DefNode extends Node {
        ...
        public DefNode(int startOffset, int length, int serializedLength, Loader loader, String name, Node receiver, ParametersNode parameters, Node body, String[] locals) {
            super(startOffset, length);
     ...
     * </pre>
     */
    public static final class ErrorRecoveryNode extends Node {
        /**
         * <pre>
         ...
         */
        @Nullable
        public final Node unexpected;

        public ErrorRecoveryNode(int startOffset, int length, Node unexpected) {
            super(startOffset, length);
        ...
        protected String toString(String indent) {
            ...
            builder.append(this.unexpected == null ? "null\n" : this.unexpected.toString(nextIndent));
            return builder.toString();
        }
    }
