...
/* templates/java/api/src/main/java-templates/org/ruby_lang/prism/AbstractNodeVisitor.java.erb */
...
public abstract class AbstractNodeVisitor<T> {
     ...
     * @return The result of visiting the node.
     */
    public T visitErrorRecoveryNode(Nodes.ErrorRecoveryNode node) {
        return defaultVisit(node);
    }
